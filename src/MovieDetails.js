...
export default function MovieDetails({ defaultRating = 0, selectedMovieId, apiKey, setIsLoading, setError, onCloseMovie, onAddWatched, watchedMovies }) {
    ...
    }, [selectedMovieId, apiKey]) //eslint-disable-line react-hooks/exhaustive-deps
            ...
            < div className={`${Styles.details}`} >
                ...
                <header className={`${Styles["details-header"]} `}>
                    ...
                    <div className={`${Styles["details-overview"]} `} >
                        ...
                        <p className={`${Styles["details-release"]} `}>{released} &bull; {runtime} </p>
                        <p className={`${Styles["details-genre"]} `}>{genre}</p>
                        <p className={`${Styles["details-imdbrating"]} `}>
                            <span>⭐️ </span>{imdbRating} IMDb rating</p>
                    </div>
                </header >
                <section className={`${Styles["details-body"]} `} >
                        ...
                        {isWatched
                            ? (
                                <p className={`${Styles["details-rating-text"]} `} >
                                    you rated movie <strong>{isWatched.userRating}</strong> <span>⭐️</span>
                                </p>
                            )
                            : (
                                <div className={`${Styles["details-rating-box"]} `}>
                                    <div className={`${Styles["details-rating-stars"]} `}>
                                        <Rating maxRating={10} defaultRating={defaultRating} onSetExtenalRate={setExternalRate}
                                            onSetExtenalHoverRate={setExternalHoverRate} color={`var(--accent-color)`} />
                                        <p className={`${Styles["details-rating-value"]} `}>
                                            {externalHoverRate || externalRate || "  "}
                                        </p>
                                    </div>
                                    <button className={`${Styles["details-rating-btn"]} `} onClick={handleAdd} disabled={externalRate < 1}>
                    ...
                    <p className={`${Styles["details-plot"]} `}><em>{plot}</em></p>
                    <p className={`${Styles["details-actors"]} `}>{actors}</p>
                    <p className={`${Styles["details-director"]} `}>Directed by {director}</p>
                </section >
